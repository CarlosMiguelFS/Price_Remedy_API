...
def get_drogasil_session():
    with sync_playwright() as p:
        ...
        page.goto("https://www.drogaraia.com.br", timeout=60000)
...
def check_drogasil(cep, produto):
    ...
    d_para_link = {
        "Mounjaro 2,5mg/ml": "https://www.drogaraia.com.br/mounjaro-2-5mg-solucao-injetavel-0-5ml-4-canetas-aplicadoras-1272170.html",
        "Mounjaro 5mg/ml": "https://www.drogaraia.com.br/mounjaro-5mg-solucao-injetavel-0-5ml-4-canetas-aplicadoras-1272173.html",
        "Mounjaro 7,5mg/ml": "https://www.drogaraia.com.br/mounjaro-7-5mg-solucao-injetavel-0-5ml-4-canetas-aplicadoras-1272174.html",
        "Mounjaro 10mg/ml": "https://www.drogaraia.com.br/mounjaro-10mg-solucao-injetavel-0-5ml-4-canetas-aplicadoras-1272177.html",
        "Ritalina 10mg 30 comprimidos": "https://www.drogaraia.com.br/ritalina-10-mg-com-30-comprimidos-a3.html",
        "Ritalina 10mg 60 comprimidos": "https://www.drogaraia.com.br/ritalina-10-mg-com-60-comprimidos-a3.html",
        "Ritalina LA 10mg/ml": "https://www.drogaraia.com.br/ritalina-la-10mg-com-30-capsulas-a3.html",
        "Ritalina LA 30mg/ml": "https://www.drogaraia.com.br/ritalina-30mg-acao-prolongada-30-capsulas-gelatinosas-a3.html",
        "Ritalina LA 40mg/ml": "https://www.drogaraia.com.br/ritalina-40mg-acao-prolongada-30-capsulas-gelatinosa-a3.html",
        "Ritalina LA 20mg/ml": "https://www.drogaraia.com.br/ritalina-la-20mg-acao-prolongada-30-capsulas-gelatinosa-a3.html"
    }

    if chave_produto not in d_para:
        return None

    url_raia = "https://www.drogaraia.com.br/api/next/product-hub/graphql"
    ...
    try:
        ...
        with httpx.Client(headers=headers, cookies=cookies, timeout=30) as client:
            resp_price = client.post(url_raia, json=json_price).json()
            ...
            resp_freight = client.post(url_raia, json=json_freight).json()
