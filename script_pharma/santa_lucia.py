...
def check_santa_lucia(cep,produto):
    ...
    endereco = Crawler.requests_pattern_freight(cep, d_para[produto], url_frete, "SANTA_LUCIA")

    if endereco:
        return {"loja": "Santa Lucia", "disponibilidade": endereco, "url":d_para_link[produto], "melhor_preco" : round(best_price, 2), "preco_padrao":round(standard_price, 2),"porcentagem_diferenca":round(percentage_price, 2)}
    
    return None

print(check_santa_lucia("29161-716","Ritalina LA 20mg/ml"))